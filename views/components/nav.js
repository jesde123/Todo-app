...
const createNavHome = () => {
    ...
    <div class="hidden md:flex flex-row gap-4">
        <a href="/login/" class="transition ease-in-out text-white font-bold bg-indigo-500 hover:bg-indigo-600 py-2 px-4 rounded-lg">login</a>
...
const createNavLogin = () => {
    ...
    <!-- version escritorio -->
    <div class="hidden md:flex flex-row gap-4">
        <a href="/signup/" class="transition ease-in-out text-white font-bold bg-indigo-500 hover:bg-indigo-600 py-2 px-4 rounded-lg">Registro</a>
   </div>
...
const createNavTodos = () => {
    ...
    <!-- version escritorio -->
    <div class="hidden md:flex flex-row gap-4">
        <button id="close-btn" class="transition ease-in-out text-white font-bold bg-indigo-500 hover:bg-indigo-600 py-2 px-4 rounded-lg">Cerrar sesion</button>
   </div>

   <!-- menu movil -->
    <div class="bg-slate-900/60 fixed top-16 right-0 left-0 bottom-0 justify-center items-center flex-col gap-4 hidden">
        <button id="clese-btn" class="transition ease-in-out text-white font-bold bg-indigo-500 hover:bg-indigo-600 py-2 px-4 rounded-lg">Cerrar sesion</button>
